...
INSERT INTO MUNGCATBOARD (id, nickname, email, subject, content, image1, profile, ref, lev, step, pseq, reply, hit, category, logtime) VALUES
('user1', 'User One', 'user1@example.com', 'First Post', 'Content for the first post', NULL, NULL, 0, 0, 0, 0, 0, 0, 0, NOW()),
('user2', 'User Two', 'user2@example.com', 'Second Post', 'Content for the second post', NULL, NULL, 0, 0, 0, 0, 0, 0, 0, NOW()),
('user3', 'User Three', 'user3@example.com', 'Third Post', 'Content for the third post', NULL, NULL, 0, 0, 0, 0, 0, 0, 0, NOW()),
('user4', 'User Four', 'user4@example.com', 'Fourth Post', 'Content for the fourth post', NULL, NULL, 0, 0, 0, 0, 0, 0, 0, NOW()),
('user5', 'User Five', 'user5@example.com', 'Fifth Post', 'Content for the fifth post', NULL, NULL, 0, 0, 0, 0, 0, 0, 0, NOW()),
('user6', 'User Six', 'user6@example.com', 'Sixth Post', 'Content for the sixth post', NULL, NULL, 0, 0, 0, 0, 0, 0, 0, NOW());
