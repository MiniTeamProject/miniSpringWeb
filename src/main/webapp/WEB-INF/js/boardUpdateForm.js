$(document).ready(function() {
    ...
    $('#updateBtn').on('click', function() {
        ...
        $.ajax({
            type: 'post',
            url: '/miniSpringWeb/board/boardUpdate', // 게시물 저장 URL
            data: formData,
            processData: false,
            contentType: false,
    ...
    $("#deleteBtn").on('click', function(){
        ...
        if(inputPwd === null || inputPwd === "") {
            ...
            $.ajax({
                type: "post",
                url: "/miniSpringWeb/board/boardDelete",
                data: {
                    id: id,
                    pwd: pwd,
                    pg: pg,
                ...
                success: function(response) {
                    ...
                    if(result != 'fail') {
                        alert("삭제가 완료되었습니다.")
                        location.href="/miniSpringWeb/board/boardMain?pg=" + pg;
                    } else {
